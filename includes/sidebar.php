    <nav class="sidebar">
        <div class="p-4">
            ...
            <ul class="flex flex-col space-y-4">
                <li><a href="./users_management.php" class="text-yellow-300 hover:text-yellow-500 flex items-center">
                ...
                <li class="mt-auto"><a href="../auth/logout.php" class="text-yellow-300 hover:text-yellow-500 flex items-center">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
