    ...
    <footer class="bg-black p-8 text-center">
        ...
        <ul class="flex justify-center space-x-4 mt-4">
            <li><a href="#" class="text-yellow-300 hover:text-yellow-500">Politique de confidentialité</a></li>
            <li><a href="#" class="text-yellow-300 hover:text-yellow-500">Conditions d'utilisation</a></li>
            <li><a href="#" class="text-yellow-300 hover:text-yellow-500">Aide</a></li>
        </ul>
